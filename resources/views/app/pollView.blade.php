                            ...
                            <div class="card card-flush mb-6 mb-xl-9 justify-content-around">
                                ...
                                <div class="card-header pt-5">
                                    ...
                                    <div class="card-toolbar">
                                        ...
                                        <div>
                                            <!--begin::Add user-->
                                            <button type="button" class="btn btn-primary ms-10 me-10" data-bs-toggle="modal" data-bs-target="#kt_modal_add_options">
                                            <i class="ki-outline ki-plus fs-2"></i>Add Option</button>
                                            <!--end::Add user-->
                                        </div>
                                        <!--end::Search-->
                                        <!--begin::Group actions-->
                                        <div class="d-flex justify-content-end align-items-center d-none" data-kt-option-table-toolbar="selected">
                                            ...
                                            <button type="button" class="btn btn-danger" data-kt-option-table-select="delete_selected">Delete Selected</button>
                                        </div>
                                        <form id="deleteOptionForm" action="{{ route('polls.deleteOption', ['poll' => $poll]) }}" method="POST" style="display: none;">
                                            @csrf
                                            @method('DELETE')
