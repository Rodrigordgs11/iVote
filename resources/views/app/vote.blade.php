                            ...
                            <div class="card-header pt-5">
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end align-items-center d-none" data-kt-option-vote-table-toolbar="selected">
                                        ...
                                        <button type="button" class="btn btn-success" data-kt-option-vote-table-select="option_selected">Vote</button>
                                    </div>
                                    <form id="voteForm" action="{{ route('votes', ['poll' => $poll]) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('POST')
                                        <input type="hidden" name="selected_options" id="selectedVoteOptions">
                                    </form>
                                    <!--end::Group actions-->
                                </div>
                                <!--end::Card toolbar-->
